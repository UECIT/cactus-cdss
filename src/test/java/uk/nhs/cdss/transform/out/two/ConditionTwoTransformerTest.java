...
import static uk.nhs.cdss.testHelpers.matchers.FhirMatchers.isValidV2Condition;
...
public class ConditionTwoTransformerTest {

  @InjectMocks
  private ConditionTwoTransformer conditionTransformer;
  ...
  public void shouldTransformConcern_defaultOnset() {
    ...
    assertThat(transformed, isValidV2Condition());
